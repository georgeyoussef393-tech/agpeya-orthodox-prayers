...
data class CopticDate(
    ...
    val synaxariumSummaryEn: String,
    val synaxariumSummaryAr: String,
...
object CopticCalendarHelper {
    ...
    fun getCopticDate(calendar: Calendar = Calendar.getInstance()): CopticDate {
        ...
        val feastInfo = getFeastAndSynaxarium(clampedMonth, clampedDay, gMonth, gDay, dayOfWeek)
        ...
        return CopticDate(
            ...
            synaxariumSummaryEn = feastInfo.synaxariumEn,
            synaxariumSummaryAr = feastInfo.synaxariumAr,
    ...
    private data class DayLiturgicalInfo(
        ...
        val feastEn: String?,
        val feastAr: String?,
        val synaxariumEn: String,
        val synaxariumAr: String,
        val katamerosPsalmEn: String,
        val katamerosPsalmAr: String,
        val katamerosGospelEn: String,
        val katamerosGospelAr: String
    ...
    private fun getFeastAndSynaxarium(
        cMonth: Int,
        cDay: Int,
        gMonth: Int,
        gDay: Int,
        ...
        if (cMonth == 1 && cDay == 1) {
            return DayLiturgicalInfo(
                ...
                synaxariumEn = "Commemoration of the Glorious Martyrs of the Coptic Church and the dawn of the Year of the Martyrs (Anno Martyrum).",
                synaxariumAr = "تذكار الشهداء القديسين الأبرار وافتتاح السنة القبطية التوتية المباركة.",
        ...
        if (cMonth == 1 && cDay in 17..19) {
            return DayLiturgicalInfo(
                ...
                synaxariumEn = "Apparition and discovery of the Precious Life-giving Cross of our Lord Jesus Christ by Queen Helena.",
                synaxariumAr = "تذكار ظهور الصليب المقدس المحيي للملكة القديسة هيلانة في أورشليم.",
        ...
        if (cMonth == 4 && (cDay == 28 || cDay == 29)) {
            return DayLiturgicalInfo(
                ...
                synaxariumEn = "The Incarnation and Birth of our Lord and Savior Jesus Christ from the Holy Virgin Mary in Bethlehem.",
                synaxariumAr = "تذكار ميلاد ربنا وإلهنا ومخلصنا يسوع المسيح بالجسد في مزود بيت لحم.",
        ...
        if (cMonth == 5 && cDay == 11) {
            return DayLiturgicalInfo(
                ...
                synaxariumEn = "The Holy Baptism of our Lord Jesus Christ by St. John the Baptist and the manifestation of the Holy Trinity.",
                synaxariumAr = "معمودية مخلصنا الصالح في نهر الأردن بيدي القديس يوحنا المعمدان وظهور الثالوث القدوس.",
        ...
        if (cMonth == 7 && cDay == 29) {
            return DayLiturgicalInfo(
                ...
                synaxariumEn = "The Annunciation of the Archangel Gabriel to the Holy Mother of God of the birth of the Savior.",
                synaxariumAr = "بشارة الملاك الجليل جبرائيل لستنا العذراء مريم بميلاد مخلص العالم.",
        ...
        if (cMonth == 12 && cDay == 16) {
            return DayLiturgicalInfo(
                ...
                synaxariumEn = "The Glorious Assumption of the immaculate body of the Theotokos to Heaven.",
                synaxariumAr = "تذكار صعود جسد والدة الإله القديسة الطاهرة مريم العذراء إلى السماء.",
        ...
        if (cMonth == 11 && cDay == 5) {
            return DayLiturgicalInfo(
                ...
                synaxariumEn = "Martyrdom of the Holy Apostles St. Peter and St. Paul in Rome.",
                synaxariumAr = "تذكار استشهاد هامتَي الرسل القديس بطرس والقديس بولس في رومية.",
        ...
        if (cDay == 12) {
            ...
            return DayLiturgicalInfo(
                ...
                synaxariumEn = "Monthly commemoration of Archangel Michael, commander of the Heavenly Host and protector of believers.",
                synaxariumAr = "تذكار الملاك الجليل ميخائيل رئيس جند الرب والشفيع المنجي لشعب الله.",
        ...
        if (cDay == 21) {
            ...
            return DayLiturgicalInfo(
                ...
                synaxariumEn = "Monthly remembrance of the pure Theotokos, our heavenly intercessor before Christ.",
                synaxariumAr = "التذكار الشهري لستنا مريم العذراء فخر جنسنا وشفيعتنا المؤتمنة أمام العرش الإلهي.",
        ...
        if (cMonth == 5 && cDay == 22) {
            return DayLiturgicalInfo(
                ...
                synaxariumEn = "Departure of the Father of Monasticism, St. Anthony the Great, who filled the desert with prayers.",
                synaxariumAr = "نياحة كوكب البرية وأب جميع الرهبان القديس العظيم الأنبا أنطونيوس الكبير.",
        ...
        if (cMonth == 8 && cDay == 23) {
            return DayLiturgicalInfo(
                ...
                synaxariumEn = "Martyrdom of the Great Martyr St. George of Cappadocia after 7 years of enduring tortures.",
                synaxariumAr = "تذكار استشهاد أمير الشهداء والقائد العظيم مارجرجس الروماني بعد ثباته العظيم.",
        ...
        if (cMonth == 3 && cDay == 15) {
            return DayLiturgicalInfo(
                ...
                synaxariumEn = "Martyrdom of the brave soldier of Christ, St. Mina the Wonderworker.",
                synaxariumAr = "تذكار استشهاد القديس البار المحبوب مارمينا صاحب الشفاعات والعجائب الكثيرة.",
        ...
        if ((cMonth == 3 && cDay >= 16) || (cMonth == 4 && cDay <= 27)) {
            ...
            return DayLiturgicalInfo(
                ...
                synaxariumEn = "Holy Season of expectation and preparation for the Nativity of Christ with blessed Kiahk Theotokia praises.",
                synaxariumAr = "أيام الصوم والاستعداد لميلاد المسيح بالتسابيح الكيهكية والمدائح الروحية للعذراء مريم.",
        ...
        if (cMonth == 12 && cDay in 1..15) {
            return DayLiturgicalInfo(
                ...
                synaxariumEn = "Blessed 15-day fast dedicated to the Holy Virgin Mary in prayer and asceticism.",
                synaxariumAr = "صوم السيدة العذراء الطاهرة أم النور، صوم الفرح والشفاعة والطلبات المقبولة.",
        ...
        if (isWedOrFri) {
            return DayLiturgicalInfo(
                ...
                synaxariumEn = "Weekly canonical fasting day commemorating the Lord's suffering and salvation.",
                synaxariumAr = "صوم كنسي أسبوعي مبارك لذكرى آلام الفداء والصليب ومحبة المخلص الباذلة.",
        ...
        return DayLiturgicalInfo(
            ...
            feastEn = null,
            feastAr = null,
            synaxariumEn = "Commemoration of the Fathers and Saints of this day in the Coptic Synaxarium.",
            synaxariumAr = "تذكار الآباء والقديسين الكرام المعيد لهم في السنكسار القبطي لهذا اليوم المبارك.",
